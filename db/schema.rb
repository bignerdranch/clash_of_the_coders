...
ActiveRecord::Schema.define(version: 20150304215611) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "competition_years", force: :cascade do |t|
  ...
  create_table "scores", force: :cascade do |t|
    ...
    t.integer  "wizardry_points", default: 0, null: false
    t.integer  "learning_points", default: 0, null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "gravatar",    limit: 255,                null: false
    t.string   "name",        limit: 255,                null: false
    t.integer  "uid"
    t.datetime "created_at"
    t.datetime "updated_at"
